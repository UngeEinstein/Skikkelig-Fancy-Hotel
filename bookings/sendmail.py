...
message_plain = """\
Subject: Takk for din booking

Vi takker for din bestilling!"""

def get_html_content(first_name, last_name, check_in_date, check_out_date, roomtype, persons, reservation_number, extra):
    return """\
    ...
    <p style="font-size: 14px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><strong><span style="font-size: 18px;">Ditt rom  fra """ + check_in_date + """ til """ + check_out_date + """ er nå bestilt!</span></strong></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    ...
    <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;"><span style="color: #000000; font-size: 14px;"><strong>Hei """+ first_name + " " + last_name  +""",</strong></span><br/>Vi takker for din bestilling:</p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, Verdana, sans-serif"><![endif]-->
    ...
    <div style="font-size: 12px; line-height: 1.5; color: #71777D; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px;">
    <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;"><span style="color: #000000; font-size: 14px;"><strong> Romtype: """ + roomtype + """</strong></span></p>
    <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">""" + check_in_date + """ til """ + check_out_date + """</p>
    <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">Antall personer: """ + persons + """</p>
    <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">Ekstra kriterier: """ + extra + """</p>
    <p style="font-size: 14px; line-height: 1.5; text-align: left; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">Reservasjonsnummer: """ + reservation_number + """</p>
...
def mail_send_booking_receipt(receiver_email, first_name, last_name, check_in_date, check_out_date, roomtype, persons, reservation_number, extra):
    ...
    part2 = MIMEText(get_html_content(first_name, last_name, check_in_date, check_out_date, roomtype, persons, reservation_number, extra), "html")
